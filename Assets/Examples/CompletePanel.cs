...
namespace THEBADDEST.UI
{
	...
	public class CompletePanel : UIPanel
	{
		...
		{
			base.Enter();
			Tweener tweener = new Tweener(transform, StartCoroutine);
			tweener.onCompleteIteration += DoOtherAnimation;
			tweener.Scale(Vector3.zero, Vector3.one, 0.5f).SetEase(TweenerEasing.Ease.EaseInBounce);
		}
